...
<head>
    ...
    <link rel="preload" href="<?= BASE_URL ?>assets/vendors/fonts/inter.css" as="style">
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>assets/vendors/fonts/inter.css">
    ...
    <div class="nav-container">
        ...
        <ul class="nav-menu" id="navMenu">
            ...
            <li class="user-profile">
                ...
                <div class="user-avatar"><?= substr($_SESSION['user']['name'], 0, 1) ?></div>
